        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <section className="text-center space-y-6">
            ...
            <div className="relative max-w-2xl mx-auto">
              <Input type="text" placeholder="Ask anything about startup growth, funding, or strategies..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="w-full h-14 pl-12 pr-4 border border-gray-200 focus:border-gray-400 transition-colors text-gray-900 placeholder:text-gray-500 rounded-sm" />
